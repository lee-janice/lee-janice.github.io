...
const Writing: React.FC<PageProps> = ({ data }: PageProps<Queries.WritingPage>) => {
    ...
    return (
        <main>
            ...
            <div className="content" style={{ maxWidth: "1000px" }}>
                {posts.map(({ node }) => (
                    <StyledPostListing>
                        {/* <StyledPostListing key={node.fields.slug}> */}
...
export const query = graphql`
    query WritingPage {
        ...
        allMarkdownRemark(
            filter: { frontmatter: { published: { ne: false } }, fileAbsolutePath: { regex: "/(writing)/" } }
